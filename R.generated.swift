...
struct R: Rswift.Validatable {
  ...
  struct image {
    /// Image `SpaceX-Logo`.
    static let spaceXLogo = Rswift.ImageResource(bundle: R.hostingBundle, name: "SpaceX-Logo")
    /// Image `fail`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "SpaceX-Logo", bundle: ..., traitCollection: ...)`
    static func spaceXLogo(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.spaceXLogo, compatibleWith: traitCollection)
    }
    #endif
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct launchScreen: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "SpaceX-Logo", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'SpaceX-Logo' is used in storyboard 'LaunchScreen', but couldn't be loaded.") }
